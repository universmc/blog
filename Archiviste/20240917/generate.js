...
const subject = process.argv[2] || 'réseau_neuronal_de_botNet_Telegram'; //  Obtenir le sujet via l'argument de ligne de commande

const generateMarkdown = async subject => {
  // Votre code pour générer le Markdown ici
