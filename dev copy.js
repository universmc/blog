...
const imagePrompts = {
  ...
  'cybersecurity': "A sophisticated 3D shield with intricate patterns, deflecting malicious code attacks while being surrounded by digital data streams, symbolizing the resilience of cybersecurity measures.",
  'IoT': "A network of interconnected everyday objects, each with a digital aura and communicating with one another through wireless signals, reflecting the concept of Internet of Things.",
