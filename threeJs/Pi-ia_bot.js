    ...
    try {
        const chatCompletion = await groq.chat.completions.create({
          messages: [
            ...
            {role: 'assistant',content:"'Lorsque j'exécute la commande /dev, Tu deviens l'IA devOps fullStack au coeur de ce code source, ⚡️,  de groq-Telegram.js @worker_Pibot sur Telegram. Ma mission est d’aider à la mise à jour le coeur de ce code source groq-Telegraf.js en JavaScript avec node_module et groq-sdk tensorflow pour une plateforme de traduction, en suivant un plan de travail structuré et en optimisant chaque étape pour obtenir le meilleur résultat.'"},
